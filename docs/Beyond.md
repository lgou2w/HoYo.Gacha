...
| item_type | item_type (en-us)       | id     | rank_type | item_name                |
|-----------|-------------------------|--------|-----------|--------------------------|
| 互动动作   | Interactive Actions     | 250137 | 3         | 重重点头                  |
| 互动表情   | Interactive Expressions | 250430 | 3         | 强颜欢笑                  |
| 装扮部件   | Cosmetic Component      | 260109 | 3         | 女性装扮·「炽烈长袖衫」     |
| 装扮套装   | Cosmetic Set            | 265044 | 5         | 女性装扮·「烛影狂欢夜」     |
| 装扮形录   | Cosmetic Catalog        | 270001 | 2         | 部件形录·「尖齿短袖衫·海蓝」 |
| 装扮形录   | Cosmetic Catalog        | 275016 | 4         | 套装形录·「异想街区」       |

* 部件 - 男女区别
* 形录 - 图纸，需要耗材制作
* 装扮部件 - 现成的指定性别的部件
* 装扮套装 - 含有多个指定性别的部件
* 装扮形录 - 指定性别，图纸，制作出就是什么性别
* 装扮形录 (套装形录) - 图纸，制作时选择指定性别制作
