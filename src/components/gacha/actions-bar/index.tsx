...
import GachaActionExtShare, { GachaActionExtShareProps } from './action-ext-share'
...
export interface GachaActionsBarProps {
  ...
  extShareProps: GachaActionExtShareProps
}

export default function GachaActionsBar (props: GachaActionsBarProps) {
  const { urlProps, fetchProps, tabsProps, extProps, extShareProps } = props
  return (
    <Stack flexDirection="row" gap={2}>
      ...
      <Stack flexDirection="row" gap={3} marginLeft="auto">
        ...
        <GachaActionExtShare {...extShareProps} />
      </Stack>
    </Stack>
  )
}
